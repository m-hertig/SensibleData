...
/*Stepper Defaults*/
#define STEPS_PER_MOTOR_REVOLUTION 32 // my stepper(28BYJ-48) is a geared stepper
#define STEPS_PER_OUTPUT_REVOLUTION 2048 // my stepper(28BYJ-48) is a geared stepper
...
#define  COMMAND_ROTATEWHEEL      'R'    //initial commant to rotate stamp wheel    from computer
...
private:
    ...
    int   pin;
    Stepper stepper = Stepper(STEPS_PER_MOTOR_REVOLUTION, STEPPER_PIN1, STEPPER_PIN2, STEPPER_PIN3, STEPPER_PIN4);
...
private:
    ...
    int calcInt(byte b_1, byte b_2, byte b_3, byte b_4);
